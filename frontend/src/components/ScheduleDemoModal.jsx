...
//   return (
//     <div className="eaq-schedule-page">

//       {/* ================= BACKGROUND IMAGE ================= */}
//       <div className="eaq-background-image"></div>

//       {/* Dark / Blue overlay */}
//       <div className="eaq-background-overlay"></div>
...
//           <div
//             className="eaq-demo-form-card eaq-fade-in-up"
...
//                   Essential Aquatech Experts
//                 </span>
//               </h2>

//               <p className="eaq-form-subtitle-text">
//                 Discover how Essential Aquatech can transform your
//                 aquaculture operations. Schedule a personalized demo
...
//                   <label
//                     htmlFor="eaqFirstName"
//                     className="eaq-form-label eaq-form-label-required"
//                   >
//                     First Name
//                   </label>
...
//                 <button
//                   type="submit"
//                   className={`eaq-submit-btn ${
//                     isSubmitting ? "eaq-btn-loading" : ""
//                   }`}
//                   disabled={isSubmitting}
//                 >
...
//         {/* ================= BENEFITS ================= */}
//         <div
//           className="eaq-benefits-section eaq-fade-in-up"
//           style={{ animationDelay: "0.4s" }}
//         >

//           <div className="eaq-benefit-card">

//             <div className="eaq-benefit-icon">
//               ⚡
//             </div>

//             <h4 className="eaq-benefit-title">
//               Quick Response Time
//             </h4>

//             <p className="eaq-benefit-desc">
...
//             <p className="eaq-benefit-desc">
//               Talk directly with our aquaculture specialists and technical experts
//             </p>
...
//             <p className="eaq-benefit-desc">
//               Get a demo customized for your specific needs and requirements
//             </p>
...
function ScheduleDemoModal() {
  ...
  useEffect(() => {
    if (submitMessage && submitMessage.includes("Thank you")) {
  ...
  return (
    <div className="eaq-schedule-page">
      ...
      {/* =====================================================
          FULL IMAGE
          ===================================================== */}
      <section className="eaq-demo-image-section">
        <img
          src="https://res.cloudinary.com/p8fs2e1n/image/upload/demo.png"
          alt="Aquaculture Schedule Demo"
          className="eaq-demo-full-image"
        />
      </section>
      ...
      {/* =====================================================
          FORM SECTION
          ===================================================== */}
      <section className="eaq-schedule-demo-wrapper">
            ...
            >
              ...
              <div className="eaq-submit-btn-container">
                ...
                >
                  ...
                  {isSubmitting ? (
                    <>
                      <span className="eaq-spinner"></span>
                      Submitting...
                    </>
                  ) : (
                    <>
        ...
        >
          ...
          <div className="eaq-benefit-card">
            ...
            <p className="eaq-benefit-desc">
              Talk directly with our aquaculture specialists and
              technical experts.
            </p>
          </div>
          ...
          <div className="eaq-benefit-card">
            ...
            <p className="eaq-benefit-desc">
              Get a demo customized for your specific needs and
              requirements.
            </p>
          </div>
